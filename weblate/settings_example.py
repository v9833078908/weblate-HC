...
# configured model must support strict structured outputs.
...
# Retry a duplicate delivery behind the producer execution guard for eight hours.
JUDGE_GUARD_WAIT_RETRIES = 480
...
JUDGE_MAX_TOKENS = 0
# Per-seat values are strings so "inherit" keeps the corresponding global
# setting above. The profile resolver validates and coerces explicit values.
JUDGE_REASONING_EFFORT_SEAT_1 = "inherit"
JUDGE_REASONING_EFFORT_SEAT_2 = "inherit"
JUDGE_RESPONSE_FORMAT_SEAT_1 = "inherit"
JUDGE_RESPONSE_FORMAT_SEAT_2 = "inherit"
JUDGE_STREAM_SEAT_1 = "inherit"
JUDGE_STREAM_SEAT_2 = "inherit"
JUDGE_BATCH_SIZE_SEAT_1 = "inherit"
JUDGE_BATCH_SIZE_SEAT_2 = "inherit"
JUDGE_REQUEST_DEADLINE_SEAT_1 = "inherit"
JUDGE_REQUEST_DEADLINE_SEAT_2 = "inherit"
JUDGE_TEMPERATURE_SEAT_1 = "inherit"
JUDGE_TEMPERATURE_SEAT_2 = "inherit"
JUDGE_MAX_TOKENS_SEAT_1 = "inherit"
JUDGE_MAX_TOKENS_SEAT_2 = "inherit"
...
JUDGE_DEFERRAL_CIRCUIT_FAILURE_THRESHOLD = 5
JUDGE_DEFERRAL_CIRCUIT_OPEN_SECONDS = 900
JUDGE_DEFERRAL_TOKEN_BUCKET_CAPACITY = 200
JUDGE_DEFERRAL_TOKEN_BUCKET_REFILL_PER_SECOND = 0.25
JUDGE_DEFERRAL_OPERATOR_STOPPED = False
JUDGE_DEFERRAL_CLOSED_RETENTION_DAYS = 90
JUDGE_REQUEST_ATTEMPT_RETENTION_DAYS = 90
# Availability fallback: tried once per batch after the primary's own
# retries are spent. Empty by default. The six non-reasoning settings must be
# set together and the endpoint must differ from the primary's; reasoning
# effort is optional, where empty means "send no reasoning parameter".
