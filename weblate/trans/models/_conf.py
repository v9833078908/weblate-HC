...
class WeblateConf(AppConf):
    ...
    JUDGE_GUARD_WAIT_RETRIES = defaults.DEFAULT_JUDGE_GUARD_WAIT_RETRIES
    ...
    JUDGE_REQUEST_DEADLINE_SEAT_1 = defaults.DEFAULT_JUDGE_REQUEST_DEADLINE_SEAT_1
    JUDGE_REQUEST_DEADLINE_SEAT_2 = defaults.DEFAULT_JUDGE_REQUEST_DEADLINE_SEAT_2
    ...
    JUDGE_DEFERRAL_CLOSED_RETENTION_DAYS = (
        defaults.DEFAULT_JUDGE_DEFERRAL_CLOSED_RETENTION_DAYS
    )
    JUDGE_REQUEST_ATTEMPT_RETENTION_DAYS = (
        defaults.DEFAULT_JUDGE_REQUEST_ATTEMPT_RETENTION_DAYS
    )
    JUDGE_FALLBACK_BASE_URL = defaults.DEFAULT_JUDGE_FALLBACK_BASE_URL
    JUDGE_FALLBACK_API_KEY = defaults.DEFAULT_JUDGE_FALLBACK_API_KEY
    JUDGE_FALLBACK_MODEL_SEAT_1 = defaults.DEFAULT_JUDGE_FALLBACK_MODEL_SEAT_1
    JUDGE_FALLBACK_MODEL_SEAT_2 = defaults.DEFAULT_JUDGE_FALLBACK_MODEL_SEAT_2
    JUDGE_FALLBACK_REASONING_EFFORT_SEAT_1 = (
        defaults.DEFAULT_JUDGE_FALLBACK_REASONING_EFFORT_SEAT_1
    )
    JUDGE_FALLBACK_REASONING_EFFORT_SEAT_2 = (
        defaults.DEFAULT_JUDGE_FALLBACK_REASONING_EFFORT_SEAT_2
    )
    JUDGE_FALLBACK_RESPONSE_FORMAT_SEAT_1 = (
        defaults.DEFAULT_JUDGE_FALLBACK_RESPONSE_FORMAT_SEAT_1
    )
    JUDGE_FALLBACK_RESPONSE_FORMAT_SEAT_2 = (
        defaults.DEFAULT_JUDGE_FALLBACK_RESPONSE_FORMAT_SEAT_2
    )
