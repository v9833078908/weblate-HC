...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("trans", "0143_merge_20260922_1810"),
    ]
        ...
        migrations.AlterField(
            ...
            field=models.IntegerField(
                choices=[
                    ...
                    (103, "Alert dismissed"),
                    (104, "Alert reopened"),
                    (105, "Judge verdict resolved"),
                    (106, "Check fixed automatically"),
                    (107, "Judge fix undone"),
                    (108, "String key renamed"),
                    (109, "String moved"),
                    (110, "Repeat decision applied"),
                    (111, "Repeat kept independent"),
                    (112, "Repeat decision undone"),
                ],
                default=2,
            ),
        ),
