...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                "verbose_name": "Judge application",
                "verbose_name_plural": "Judge applications",
                "indexes": [
                    models.Index(
                        fields=["unit", "-applied_at"],
                        name="judge_application_unit_idx",
                    )
                ],
            },
        ),
