...
JUDGE_RESPONSE_FORMAT = get_env_str(
    "WEBLATE_JUDGE_RESPONSE_FORMAT",
    trans_defaults.DEFAULT_JUDGE_RESPONSE_FORMAT,
)
JUDGE_STREAM = get_env_bool(
    "WEBLATE_JUDGE_STREAM",
    trans_defaults.DEFAULT_JUDGE_STREAM,
)
JUDGE_TEMPERATURE = get_env_float(
    "WEBLATE_JUDGE_TEMPERATURE",
    trans_defaults.DEFAULT_JUDGE_TEMPERATURE,
)
JUDGE_MAX_TOKENS = get_env_int(
    "WEBLATE_JUDGE_MAX_TOKENS",
    trans_defaults.DEFAULT_JUDGE_MAX_TOKENS,
)
# Keep seat profile values as strings: "inherit" is resolved by the Judge
# profile resolver and must not be coerced by the environment parser.
JUDGE_REASONING_EFFORT_SEAT_1 = get_env_str(
    "WEBLATE_JUDGE_REASONING_EFFORT_SEAT_1",
    trans_defaults.DEFAULT_JUDGE_REASONING_EFFORT_SEAT_1,
)
JUDGE_REASONING_EFFORT_SEAT_2 = get_env_str(
    "WEBLATE_JUDGE_REASONING_EFFORT_SEAT_2",
    trans_defaults.DEFAULT_JUDGE_REASONING_EFFORT_SEAT_2,
)
JUDGE_RESPONSE_FORMAT_SEAT_1 = get_env_str(
    "WEBLATE_JUDGE_RESPONSE_FORMAT_SEAT_1",
    trans_defaults.DEFAULT_JUDGE_RESPONSE_FORMAT_SEAT_1,
)
JUDGE_RESPONSE_FORMAT_SEAT_2 = get_env_str(
    "WEBLATE_JUDGE_RESPONSE_FORMAT_SEAT_2",
    trans_defaults.DEFAULT_JUDGE_RESPONSE_FORMAT_SEAT_2,
)
JUDGE_STREAM_SEAT_1 = get_env_str(
    "WEBLATE_JUDGE_STREAM_SEAT_1",
    trans_defaults.DEFAULT_JUDGE_STREAM_SEAT_1,
)
JUDGE_STREAM_SEAT_2 = get_env_str(
    "WEBLATE_JUDGE_STREAM_SEAT_2",
    trans_defaults.DEFAULT_JUDGE_STREAM_SEAT_2,
)
JUDGE_BATCH_SIZE_SEAT_1 = get_env_str(
    "WEBLATE_JUDGE_BATCH_SIZE_SEAT_1",
    trans_defaults.DEFAULT_JUDGE_BATCH_SIZE_SEAT_1,
)
JUDGE_BATCH_SIZE_SEAT_2 = get_env_str(
    "WEBLATE_JUDGE_BATCH_SIZE_SEAT_2",
    trans_defaults.DEFAULT_JUDGE_BATCH_SIZE_SEAT_2,
)
JUDGE_REQUEST_DEADLINE_SEAT_1 = get_env_str(
    "WEBLATE_JUDGE_REQUEST_DEADLINE_SEAT_1",
    trans_defaults.DEFAULT_JUDGE_REQUEST_DEADLINE_SEAT_1,
)
JUDGE_REQUEST_DEADLINE_SEAT_2 = get_env_str(
    "WEBLATE_JUDGE_REQUEST_DEADLINE_SEAT_2",
    trans_defaults.DEFAULT_JUDGE_REQUEST_DEADLINE_SEAT_2,
)
JUDGE_TEMPERATURE_SEAT_1 = get_env_str(
    "WEBLATE_JUDGE_TEMPERATURE_SEAT_1",
    trans_defaults.DEFAULT_JUDGE_TEMPERATURE_SEAT_1,
)
JUDGE_TEMPERATURE_SEAT_2 = get_env_str(
    "WEBLATE_JUDGE_TEMPERATURE_SEAT_2",
    trans_defaults.DEFAULT_JUDGE_TEMPERATURE_SEAT_2,
)
JUDGE_MAX_TOKENS_SEAT_1 = get_env_str(
    "WEBLATE_JUDGE_MAX_TOKENS_SEAT_1",
    trans_defaults.DEFAULT_JUDGE_MAX_TOKENS_SEAT_1,
)
JUDGE_MAX_TOKENS_SEAT_2 = get_env_str(
    "WEBLATE_JUDGE_MAX_TOKENS_SEAT_2",
    trans_defaults.DEFAULT_JUDGE_MAX_TOKENS_SEAT_2,
)
JUDGE_MAX_UNITS_PER_RUN = get_env_int(
    "WEBLATE_JUDGE_MAX_UNITS_PER_RUN",
    trans_defaults.DEFAULT_JUDGE_MAX_UNITS_PER_RUN,
)
JUDGE_GUARD_WAIT_RETRIES = get_env_int(
    "WEBLATE_JUDGE_GUARD_WAIT_RETRIES",
    trans_defaults.DEFAULT_JUDGE_GUARD_WAIT_RETRIES,
)
...
JUDGE_REQUEST_IDLE_TIMEOUT = get_env_float(
    "WEBLATE_JUDGE_REQUEST_IDLE_TIMEOUT",
    trans_defaults.DEFAULT_JUDGE_REQUEST_IDLE_TIMEOUT,
)
JUDGE_TRANSPORT_RETRIES = get_env_int(
    "WEBLATE_JUDGE_TRANSPORT_RETRIES",
    trans_defaults.DEFAULT_JUDGE_TRANSPORT_RETRIES,
)
JUDGE_PROTOCOL_RETRIES = get_env_int(
    "WEBLATE_JUDGE_PROTOCOL_RETRIES",
    trans_defaults.DEFAULT_JUDGE_PROTOCOL_RETRIES,
)
JUDGE_TRANSIENT_HTTP_RETRIES = get_env_int(
    "WEBLATE_JUDGE_TRANSIENT_HTTP_RETRIES",
    trans_defaults.DEFAULT_JUDGE_TRANSIENT_HTTP_RETRIES,
)
JUDGE_MAX_UNPARSED_RETRY_ROUNDS = get_env_int(
    "WEBLATE_JUDGE_MAX_UNPARSED_RETRY_ROUNDS",
    trans_defaults.DEFAULT_JUDGE_MAX_UNPARSED_RETRY_ROUNDS,
)
JUDGE_RETRY_BUDGET_RATIO = get_env_float(
    "WEBLATE_JUDGE_RETRY_BUDGET_RATIO",
    trans_defaults.DEFAULT_JUDGE_RETRY_BUDGET_RATIO,
)
...
JUDGE_DEFERRAL_ENABLED = get_env_bool(
    "WEBLATE_JUDGE_DEFERRAL_ENABLED",
    trans_defaults.DEFAULT_JUDGE_DEFERRAL_ENABLED,
)
JUDGE_DEFERRAL_MIN_INTERVAL = get_env_int(
    "WEBLATE_JUDGE_DEFERRAL_MIN_INTERVAL",
    trans_defaults.DEFAULT_JUDGE_DEFERRAL_MIN_INTERVAL,
)
JUDGE_DEFERRAL_MAX_INTERVAL = get_env_int(
    "WEBLATE_JUDGE_DEFERRAL_MAX_INTERVAL",
    trans_defaults.DEFAULT_JUDGE_DEFERRAL_MAX_INTERVAL,
)
JUDGE_DEFERRAL_SLOW_AFTER = get_env_int(
    "WEBLATE_JUDGE_DEFERRAL_SLOW_AFTER",
    trans_defaults.DEFAULT_JUDGE_DEFERRAL_SLOW_AFTER,
)
JUDGE_DEFERRAL_MAX_UNITS_PER_PASS = get_env_int(
    "WEBLATE_JUDGE_DEFERRAL_MAX_UNITS_PER_PASS",
    trans_defaults.DEFAULT_JUDGE_DEFERRAL_MAX_UNITS_PER_PASS,
)
JUDGE_DEFERRAL_CIRCUIT_FAILURE_THRESHOLD = get_env_int(
    "WEBLATE_JUDGE_DEFERRAL_CIRCUIT_FAILURE_THRESHOLD",
    trans_defaults.DEFAULT_JUDGE_DEFERRAL_CIRCUIT_FAILURE_THRESHOLD,
)
JUDGE_DEFERRAL_CIRCUIT_OPEN_SECONDS = get_env_int(
    "WEBLATE_JUDGE_DEFERRAL_CIRCUIT_OPEN_SECONDS",
    trans_defaults.DEFAULT_JUDGE_DEFERRAL_CIRCUIT_OPEN_SECONDS,
)
JUDGE_DEFERRAL_TOKEN_BUCKET_CAPACITY = get_env_int(
    "WEBLATE_JUDGE_DEFERRAL_TOKEN_BUCKET_CAPACITY",
    trans_defaults.DEFAULT_JUDGE_DEFERRAL_TOKEN_BUCKET_CAPACITY,
)
JUDGE_DEFERRAL_TOKEN_BUCKET_REFILL_PER_SECOND = get_env_float(
    "WEBLATE_JUDGE_DEFERRAL_TOKEN_BUCKET_REFILL_PER_SECOND",
    trans_defaults.DEFAULT_JUDGE_DEFERRAL_TOKEN_BUCKET_REFILL_PER_SECOND,
)
JUDGE_DEFERRAL_OPERATOR_STOPPED = get_env_bool(
    "WEBLATE_JUDGE_DEFERRAL_OPERATOR_STOPPED",
    trans_defaults.DEFAULT_JUDGE_DEFERRAL_OPERATOR_STOPPED,
)
JUDGE_DEFERRAL_CLOSED_RETENTION_DAYS = get_env_int(
    "WEBLATE_JUDGE_DEFERRAL_CLOSED_RETENTION_DAYS",
    trans_defaults.DEFAULT_JUDGE_DEFERRAL_CLOSED_RETENTION_DAYS,
)
JUDGE_REQUEST_ATTEMPT_RETENTION_DAYS = get_env_int(
    "WEBLATE_JUDGE_REQUEST_ATTEMPT_RETENTION_DAYS",
    trans_defaults.DEFAULT_JUDGE_REQUEST_ATTEMPT_RETENTION_DAYS,
)
JUDGE_FALLBACK_BASE_URL = get_env_str(
    "WEBLATE_JUDGE_FALLBACK_BASE_URL",
    trans_defaults.DEFAULT_JUDGE_FALLBACK_BASE_URL,
)
JUDGE_FALLBACK_API_KEY = get_env_str(
    "WEBLATE_JUDGE_FALLBACK_API_KEY",
    trans_defaults.DEFAULT_JUDGE_FALLBACK_API_KEY,
)
JUDGE_FALLBACK_MODEL_SEAT_1 = get_env_str(
    "WEBLATE_JUDGE_FALLBACK_MODEL_SEAT_1",
    trans_defaults.DEFAULT_JUDGE_FALLBACK_MODEL_SEAT_1,
)
JUDGE_FALLBACK_MODEL_SEAT_2 = get_env_str(
    "WEBLATE_JUDGE_FALLBACK_MODEL_SEAT_2",
    trans_defaults.DEFAULT_JUDGE_FALLBACK_MODEL_SEAT_2,
)
JUDGE_FALLBACK_REASONING_EFFORT_SEAT_1 = get_env_str(
    "WEBLATE_JUDGE_FALLBACK_REASONING_EFFORT_SEAT_1",
    trans_defaults.DEFAULT_JUDGE_FALLBACK_REASONING_EFFORT_SEAT_1,
)
JUDGE_FALLBACK_REASONING_EFFORT_SEAT_2 = get_env_str(
    "WEBLATE_JUDGE_FALLBACK_REASONING_EFFORT_SEAT_2",
    trans_defaults.DEFAULT_JUDGE_FALLBACK_REASONING_EFFORT_SEAT_2,
)
JUDGE_FALLBACK_RESPONSE_FORMAT_SEAT_1 = get_env_str(
    "WEBLATE_JUDGE_FALLBACK_RESPONSE_FORMAT_SEAT_1",
    trans_defaults.DEFAULT_JUDGE_FALLBACK_RESPONSE_FORMAT_SEAT_1,
)
JUDGE_FALLBACK_RESPONSE_FORMAT_SEAT_2 = get_env_str(
    "WEBLATE_JUDGE_FALLBACK_RESPONSE_FORMAT_SEAT_2",
    trans_defaults.DEFAULT_JUDGE_FALLBACK_RESPONSE_FORMAT_SEAT_2,
)
LLM_USAGE_LOG_RETENTION_DAYS = get_env_int(
    "WEBLATE_LLM_USAGE_LOG_RETENTION_DAYS",
    trans_defaults.DEFAULT_LLM_USAGE_LOG_RETENTION_DAYS,
)
