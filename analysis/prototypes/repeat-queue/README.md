...
| `judge-bulk.html` | Проверка судьёй и массовое применение «единственного варианта без ошибок» (`?state=start\|running\|ready\|review\|done`) | состояния 1–3 — контракт фазы 1; состояния 4–5 — фаза 2, ожидает прохождения ворот из `docs/product/plans/2026-09-24-repeat-queue-producer-ux.md` |
