...
| `judge-bulk.html` | Проверка судьёй и массовое применение «единственного варианта без ошибок» (`?state=start\|running\|ready\|review\|done`) | на обсуждении, план `docs/product/plans/2026-09-24-repeat-queue-producer-ux.md`; вердикты и итоги условные |
