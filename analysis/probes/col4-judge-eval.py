...
Data. Labels and splits come from ``analysis/data/col4-judge-golden.json``. The
...
Usage::
    ...
    python analysis/probes/col4-judge-eval.py --dry-run --split dev --limit 2
