...
Deterministic and offline. Inputs:
    dev-docker/data/col4-b0-units.jsonl   (analysis/probes/col4-b0-dump.py output)
    analysis/data/col4-b0-annotations.jsonl   (task B0)
Output:
...
never shares a base with a dev one.
    ...
    uv run python analysis/probes/col4-judge-goldenset-build.py
"""
...
# --------------------------------------------------------------------------
# terminology stratum: the probe logic of analysis/probes/col4-visibility-adherence-probe.py
# --------------------------------------------------------------------------
...
def main() -> None:
    ...
    payload = {
        ...
        "built_by": "analysis/probes/col4-judge-goldenset-build.py",
        "seeds": {
