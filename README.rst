...
Внутренний сервис непрерывной локализации игры **Hero Craft Space Arena**,
...
Это не публичный деплой. Это self-hosted-инстанс Weblate плюс несколько
специфичных для игры дополнений поверх upstream. Команда Hero Craft переводит
в нём игровые строки и следит за целостностью движковой разметки.
