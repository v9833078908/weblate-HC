...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        'display-lg': ['56px', { lineHeight: '64px', letterSpacing: '-0.46px', fontWeight: '400' }],
        'metric-lg': ['40px', { lineHeight: '50px', letterSpacing: '-0.67px', fontWeight: '600' }],
        'heading-page': ['24px', { lineHeight: '31px', letterSpacing: '-0.4px', fontWeight: '600' }],
