...
const ChartStyle = ({ id, config }) => {
  ...
  return (
    <style
      // biome-ignore lint/security/noDangerouslySetInnerHtml: shadcn ChartStyle pattern; CSS built from module-level THEMES const + chart config colors, not user input
