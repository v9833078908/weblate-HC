...
* LLM judge runs now show capped scope and observed-cost previews, record per-unit judge usage, and add a component release-readiness table that keeps delivery state separate from advisory AI evidence.
