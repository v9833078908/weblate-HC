...
- Never promote `check_glossary` wholesale to blocking or to Weblate
  ...
  `analysis/probes/glossary-or-probe.py`. The deterministic strengthening path is
...
`docs/product/plans/2026-08-10-game-line-break-rule.md` already exist in this checkout.
