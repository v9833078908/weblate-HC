...
- Выгрузка: read-only через `weblate shell` **dev**-контейнера
  (`analysis/probes/col4-b0-dump.py` -> `dev-docker/data/col4-b0-units.jsonl`),
...
правки». Полные разметки: `analysis/data/col4-b0-annotations.jsonl`
(исходные 260 строк) и
`analysis/data/col4-b0-annotations-topup-20260812.jsonl` (300 строк); поля
