...
| **3. Решения и белый ящик** | `docs/llm-first/plans/2026-08-13-03-judge-decisions-and-whitebox.md` | кнопки решений с обязательной причиной, `resolution` в работе, вкладка «Оценка ИИ» с историей суда, парсер судейских спанов в `Formatter`, отдельный класс бейджа | продюсер закрывает петлю с аудит-следом; видно, почему судья решил так |
