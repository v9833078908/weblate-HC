...
Разметчик: Fable (frontier-модель Anthropic, в сессии агента) в роли
франко-нейтива. Оговорка о family bias с судьёй Anthropic mid-tier —
в плане (трек B); арбитр при подозрении — конструктивные страты.
