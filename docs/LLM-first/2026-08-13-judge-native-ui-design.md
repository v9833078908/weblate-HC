...
> продюсера. Промпт по умолчанию для реализации — **плечо C** того
> замера: `description` + рубрика severity «последствие для игрока».
> Оно единственное без проигрыша: шум коллегии −23% (39→30/124),
> REAL@14 12/14, ложные флаги deepseek вдвое ниже (8→4/83),
> precision 0.51→0.56 при recall внутри шумового пола.
