...
**`docs/misc/autofix-terminal-punctuation.md`**.
...
(`docs/misc/col4-b0-annotations.jsonl`). Он собран прототипом с
...
репозитории (`docs/misc/autofix-terminal-punctuation.md`, раздел 5).
...
```bash
uv run python docs/misc/col4-judge-goldenset-build.py --autofix-fingerprint "<из команды>"
git diff --stat docs/misc/col4-judge-golden.json
```
...
```bash
git add docs/misc/col4-judge-goldenset-build.py docs/misc/col4-judge-golden.json docs/LLM-first/plans/2026-08-11-phase0-schema-and-judge-calibration.md
...
**Step 5: Записать результат** в `docs/misc/autofix-terminal-punctuation.md`
...
7. `docs/misc/autofix-terminal-punctuation.md` содержит вердикт по `:`.
