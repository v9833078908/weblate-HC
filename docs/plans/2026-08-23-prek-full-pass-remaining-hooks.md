...
**Goal:** Finish what `docs/plans/2026-08-22-prek-clean-worktree-readiness.md`
...
- `docs/misc/*.py` (24 files, 1-16 findings each): `st2-judge-experiment.py`,
...
`docs/misc/col4-id-defects.tsv`, `docs/misc/col4-glossary-append-2026-08-14.csv`,
...
`docs/plans/2026-08-19-space-arena-game-number-and-same-noise.md`, `recal` (an <!-- # codespell:ignore -->
intentional abbreviation, `st2-zh-recal`) in three `docs/misc/`/`docs/LLM-first/`
...
`docs/plans/2026-08-17-game-number-check.md`.
...
Heaviest files: `docs/LLM-first/plans/old/2026-08-07-project-scoped-llm-context.md`
(63), `docs/plans/2026-08-12-loc-kit-glossary-smarter-inference.md` (61),
`docs/LLM-first/plans/old/2026-08-05-routed-llm-machinery.md` (44),
`docs/plans/2026-08-14-llm-usage-tracking.md` (37).
...
2. `MD036` is 71% of the findings and is NOT a safe blind autofix: it means
   ...
   that `docs/plans/` structure should not be rewritten casually. Two
   ...
   - **(b)** Add a `[tool.rumdl.overrides]` (or equivalent) MD036 exclusion
     scoped to `docs/plans/**` and `docs/LLM-first/**` - these are internal
...
`docs/specs/2026-08-11-llm-first-prompt-and-pipeline-review.md`, is already
...
`docs/LLM-first/plans/old/2026-08-05-routed-llm-machinery.md` (1),
`docs/plans/2026-08-10-loc-kit-glossary-deterministic-infer.md` (4),
`docs/plans/2026-08-10-loc-kit-glossary-note-column.md` (6),
`docs/plans/2026-08-10-loc-kit-glossary-update-existing.md` (3),
`docs/plans/2026-08-12-glossary-terminology-flag.md` (3),
`docs/plans/2026-08-12-loc-kit-glossary-smarter-inference.md` (13),
`docs/plans/2026-08-14-llm-usage-tracking.md` (5),
`docs/plans/2026-08-17-microsoft-clarity-session-recordings.md` (7),
`docs/plans/2026-08-17-outgoing-mail-webnotify.md` (2),
`docs/plans/2026-08-22-multilingual-spreadsheet-review-fixes.md` (2),
`docs/plans/2026-08-22-nested-game-placeholder-protection.md` (1),
`docs/specs/2026-08-11-col4-fr-autotranslate-report.md` (2).
...
- Rewriting `docs/plans/`/`docs/LLM-first/` content beyond what Task 5's
