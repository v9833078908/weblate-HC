...
```bash
uv run prek run --files weblate/templates/snippets/list-objects.html weblate/trans/tests/test_views.py docs/plans/2026-08-12-glossary-language-overview.md
```
