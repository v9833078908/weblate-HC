...
- Линтер — **targeted**: `uv run prek run --files <изменённые>` (как в `docs/plans/2026-08-10-loc-kit-glossary-deterministic-infer.md:574`). `--all-files` может автофиксить чужие файлы.
...
```bash
git add docs/changes.rst docs/specs/loc-kit-ingest.md docs/security/threat-model.rst
