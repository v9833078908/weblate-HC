...
**Design spec:** `docs/specs/loc-kit-ingest.md`.
...
- Match the closed schema in `docs/specs/loc-kit-ingest.md` exactly. Fields
...
```bash
git add weblate_customization/tests/test_loc_kit_ingest_live.py docs/specs/loc-kit-ingest.md
...
- `docs/specs/loc-kit-ingest.md` and this plan agree on profile-only parsing,
...
git add loc_kit_ingest/ weblate/trans/tests/test_loc_kit_ingest_contract.py \
  weblate_customization/tests/test_loc_kit_ingest_live.py \
  docs/specs/loc-kit-ingest.md docs/plans/2026-08-06-loc-kit-ingest.md
