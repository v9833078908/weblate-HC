...
- `docs/product/plans/2026-08-10-game-line-break-rule.md` - the previous check added to
...
- Create: `analysis/probes/game-number-probe.py`

### Step 1: Write the probe

The four existing `analysis/probes/*-probe.py` scripts import the real
