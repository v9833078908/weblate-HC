...
Статус: **черновик, ожидает утверждения владельцем** (раздел «Открытые
решения» — бюджет, корпус, гейт-политика). Платные стадии не начинать до
явного разрешения. Офлайн-часть задачи 1 можно исполнять сразу.
