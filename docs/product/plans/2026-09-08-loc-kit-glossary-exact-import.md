...
Дата: 2026-09-08.
Статус: **реализован и слит в `main` 2026-09-08**:
`e1e41d4326b8b37e18f245663b2bcc30242a9115`
(`feat(glossary): support exact in loc-kit glossary import`), merge
`9bb7f50a3dbd0245219cce82b8a1080dcfa69e6d`. Деплой в этом плане не
выполнялся и не подразумевается.
...
План реализован в `e1e41d4` и слит в `main` через `9bb7f50`. Коммит включает
offline parser/writer tests, Weblate contract tests, glossary-check tests,
creation/append normalizer и документацию. Production deployment остаётся
отдельным действием, требующим явного разрешения.
