...
- `docs/product/vision/llm-first-product-architecture.md` (часть 4)
...
- `docs/product/research/2026-08-11-judge-ux-competitor-research.md`
- `docs/product/measurements/2026-08-13-phase0-measurements.md` (замеры фазы 0)
- `docs/product/measurements/2026-08-19-severity-recalibration-final.md` (полный замер n=5, гейты R1-R3)
...
(`docs/product/measurements/2026-08-13-phase0-measurements.md`). Она заменила
...
Замер 2026-08-13 (`docs/product/measurements/2026-08-13-phase0-measurements.md`)
...
> (`docs/product/measurements/2026-08-14-st2-zh-judge-run.md`, раздел «Второе
...
> `docs/product/plans/2026-08-14-judge-severity-recalibration.md`.
...
`docs/product/measurements/2026-08-14-st2-zh-judge-run.md`). Реализации требования
...
4. **Отнести к следующему срезу.** Изменение промпта существенное,
   ...
   (`docs/product/measurements/2026-08-13-phase0-measurements.md`, пункт 7
...
> гейты — план `docs/product/plans/2026-08-20-judge-dialog-context.md`.
>
...
(см. преамбулу `docs/product/plans/2026-08-12-phase0-implementation.md`).
...
(`docs/product/measurements/2026-08-13-phase0-measurements.md`) отверг каскад:
...
(`docs/product/plans/2026-08-11-glossary-morphological-enforcement.md`), после
...
| **2. Навигация и готовность** | `docs/product/plans/2026-08-22-02-judge-navigation-readiness.md` | `judge_field` в `search.py`, регистрация в `FILTERS`, ключи в выпадашке формы, `calculate_judge()`, карточка «Оценка ИИ» на обзоре, баннер готовности, таблица по языкам, `NOT has:judge` как дефолтный `q` режима `judge`, счётчик строк и оценка цены под фактический `q` формы | на вопрос «можно ли отгружать билд» отвечает один экран; `NOT has:judge` показывает непокрытое; счётчик обещает ровно то, что прогон осудит |
| **3. Решения и белый ящик** | `docs/product/plans/2026-08-24-03-judge-decisions-and-whitebox.md` | кнопки решений с обязательной причиной, `resolution` в работе, вкладка «Оценка ИИ» с историей суда, парсер судейских спанов в `Formatter`, отдельный класс бейджа | продюсер закрывает петлю с аудит-следом; видно, почему судья решил так |
...
- **До плана 2 счётчик строк в форме считает не то, что будет осуждено.**
  ...
  траты денег (замер: `docs/product/measurements/2026-08-20-judge-first-dev-run.md`).
...
- **Граница ответственности судьи по глоссарию.** Проверено по
  ...
  `docs/product/measurements/2026-08-11-glossary-enforcement-analysis.md:140-170`):
...
- **Отпечаток не покрывает глоссарный матчер.** Метаданные набора пиннят
  ...
  `docs/product/plans/2026-08-11-glossary-morphological-enforcement.md` — меняет,
