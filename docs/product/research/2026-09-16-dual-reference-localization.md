...
Актуальный исполняемый протокол — версия 1.2
...
Дополнение к локальным данным: подготовлен пакет
`/Users/eli/Downloads/dual-reference-zh-2026-09-16/` и одноимённый ZIP.
В нём предложенная выборка 120 строк, полный пул 1113 пар RU/EN, исходные
выгрузки, глоссарии и офлайн-валидатор. Инструкции — §5a плана; повторное
обращение к production для подготовки этого датасета не требуется.
